...
public class MainApartmentHousingSnsViewHolder extends BaseViewHolder<MainSnsModel> {
    public MainApartmentHousingSnsViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void onBindViews(MainSnsModel data) {
